...
class DisplayTagIdGUI(Process):
  ...
  def run(self):
    ...
    scan_button = tk.Button(self.root, text="Scan", command=self.scan, height=2, width=10)
    upload_button = tk.Button(self.root, text="Upload", command=self.upload, height=2, width=10)
