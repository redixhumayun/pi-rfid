...
def tagreader_proc(x,queue,rq):
    ...
    ser=serial.Serial('/dev/ttyUSB1', 57600,timeout=0.5)
...
#########################################################################
CLIENT_ID="VAM3rEd7cV2PZiDUc579VqrGRBQfFsZi"

CLIENT_SECRET="88FzekTBJ4s1C598I-ywjMwEQk5KbyCTl8Bf8dV86WB6_ykSS3ZCjo9jTFzHmVCd"

AUDIENCE="https://api.fabtrakr.com"

GRANT_TYPE="client_credentials"

AUTH0_DOMAIN="https://dev-q9u-izlr.auth0.com/oauth/token"
# The following is the URL endpoint to hit

#SERVER_BASE_URL=http://localhost:8001
SERVER_BASE_URL="https://test.api.fabtrakr.com"
...
def upload_proc(x,queue,rq):
    ...
    while True:
        if not trq.empty():
            ...
            payload = {'latitude': mpld.get("gps")[0], 'longitude': mpld.get("gps")[1]}
            try:
            ...
            #epc = ['135U12UN1I2gn15', '2o2uN2851GH9127', '5g9228129G8H1298']
            epc=mpld.get("tags")
            ...
            for p in processes:
                if not wq.empty():
                    ...
                    if rq.find("GPS") == 0:
                        ...
                        gpslist=rq.split()
                        upglist=gpslist[1:]
                        #upglist=[ 13.03278000, 77.62371000]
